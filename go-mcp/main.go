// Command EmailValidation-mcp is an MCP server exposing the EmailValidation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EmailValidation_list  — list records of an entity
//	EmailValidation_load  — load a single record of an entity
//
