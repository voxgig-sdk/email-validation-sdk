...
func registerTools(server *mcp.Server, client *sdk.EmailValidationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "email-validation_list",
		Description: "List records from EmailValidation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "email-validation_load",
		Description: "Load a single record from EmailValidation. " +
...
func runOp(client *sdk.EmailValidationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EmailValidationSDK, name string) (sdk.EmailValidationEntity, error) {
