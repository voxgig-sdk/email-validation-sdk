...
|---|---|---|
| `ts/` | @voxgig-sdk/email-validation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/email-validation-sdk \
      --repository voxgig-sdk/email-validation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/email-validation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/email-validation-sdk --id=<id>` removes it.
