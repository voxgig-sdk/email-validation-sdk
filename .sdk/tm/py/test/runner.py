...
class EmailValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EmailValidationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EmailValidationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EmailValidationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
