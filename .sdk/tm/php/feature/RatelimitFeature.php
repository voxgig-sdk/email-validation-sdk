...
// EmailValidation SDK ratelimit feature
...
class EmailValidationRatelimitFeature extends EmailValidationBaseFeature
{
    ...
    private function _acquire(EmailValidationContext $ctx): void
    {
    ...
    private function _track(EmailValidationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
