...
// EmailValidation SDK timeout feature
...
class EmailValidationTimeoutFeature extends EmailValidationBaseFeature
{
    ...
    private function _with_timeout(EmailValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EmailValidationContext $_ctx, float $ms): void
    {
        $client = $this->client;
