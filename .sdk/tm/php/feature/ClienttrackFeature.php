...
// EmailValidation SDK clienttrack feature
...
class EmailValidationClienttrackFeature extends EmailValidationBaseFeature
{
    ...
    public function PostConstruct(EmailValidationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EmailValidation-SDK';
