...
// EmailValidation SDK netsim feature
...
class EmailValidationNetsimFeature extends EmailValidationBaseFeature
{
    ...
    private function _simulate(EmailValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EmailValidationContext $ctx, array $applied): void
    {
        $client = $this->client;
