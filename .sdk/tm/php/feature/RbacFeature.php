...
// EmailValidation SDK rbac feature
...
class EmailValidationRbacFeature extends EmailValidationBaseFeature
{
    ...
    private function _required(EmailValidationContext $ctx): ?string
    {
    ...
    private function _reject(EmailValidationContext $ctx, string $required): void
    {
    ...
    private function _track(EmailValidationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
