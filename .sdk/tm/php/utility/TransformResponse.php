...
// EmailValidation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EmailValidationTransformResponse
{
    public static function call(EmailValidationContext $ctx): mixed
    {
        ...
        $transform = EmailValidationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
