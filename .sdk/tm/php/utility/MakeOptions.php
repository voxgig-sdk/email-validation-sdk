...
// EmailValidation SDK utility: make_options

class EmailValidationMakeOptions
{
    ...
    public static function call(EmailValidationContext $ctx): array
    {
        ...
        //
        // `EmailValidationSchema::optspec()` is built from the model:
        ...
        $optspec = EmailValidationSchema::optspec();
