...
// EmailValidation SDK utility: fetcher

class EmailValidationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EmailValidationSDK/1.0)';
    ...
    public static function call(EmailValidationContext $ctx, string $fullurl, array $fetchdef): array
    {
