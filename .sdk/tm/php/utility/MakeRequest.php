...
// EmailValidation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EmailValidationMakeRequest
{
    public static function call(EmailValidationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EmailValidationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EmailValidationResponse($fetched);
        } else {
