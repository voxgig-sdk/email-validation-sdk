...
// EmailValidation SDK cache feature
...
class EmailValidationCacheFeature extends EmailValidationBaseFeature
{
    ...
    private function _through(EmailValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
