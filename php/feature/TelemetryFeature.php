...
// EmailValidation SDK telemetry feature
...
class EmailValidationTelemetryFeature extends EmailValidationBaseFeature
{
    ...
    private function _close(EmailValidationContext $ctx, bool $ok): void
    {
