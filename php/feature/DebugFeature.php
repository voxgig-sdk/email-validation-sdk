...
// EmailValidation SDK debug feature
...
class EmailValidationDebugFeature extends EmailValidationBaseFeature
{
    ...
    private function _finish(EmailValidationContext $ctx, bool $ok): void
    {
