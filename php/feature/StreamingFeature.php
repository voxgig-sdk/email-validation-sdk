...
// EmailValidation SDK streaming feature
...
class EmailValidationStreamingFeature extends EmailValidationBaseFeature
{
    ...
    private function _iterate(EmailValidationResult $result): \Generator
    {
    ...
    private function _streamable(EmailValidationContext $ctx): bool
    {
