...
// EmailValidation SDK audit feature
...
class EmailValidationAuditFeature extends EmailValidationBaseFeature
{
    ...
    private function _emit(EmailValidationContext $ctx, string $outcome): void
    {
