...
// EmailValidation SDK idempotency feature
...
class EmailValidationIdempotencyFeature extends EmailValidationBaseFeature
{
    ...
    private function _mutating(EmailValidationContext $ctx): bool
    {
