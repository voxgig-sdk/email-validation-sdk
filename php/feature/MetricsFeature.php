...
// EmailValidation SDK metrics feature
...
class EmailValidationMetricsFeature extends EmailValidationBaseFeature
{
    ...
    private function _record(EmailValidationContext $ctx, bool $ok): void
    {
