...
// EmailValidation SDK proxy feature
...
class EmailValidationProxyFeature extends EmailValidationBaseFeature
{
    ...
    public function init(EmailValidationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EmailValidationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
