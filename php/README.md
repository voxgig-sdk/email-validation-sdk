# EmailValidation PHP SDK



The PHP SDK for the EmailValidation API — an entity-oriented client using PHP conventions.
...
```php
require_once 'emailvalidation_sdk.php';
$client = new EmailValidationSDK($options);
```
...
```
php/
├── emailvalidation_sdk.php          -- Main SDK class
...
The main class (`emailvalidation_sdk.php`) exports the SDK class
