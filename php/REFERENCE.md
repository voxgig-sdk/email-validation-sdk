# EmailValidation PHP SDK Reference

Complete API reference for the EmailValidation PHP SDK.
...
#### `EmailValidationSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): EmailValidationUtility`
