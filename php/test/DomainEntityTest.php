...
class DomainEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = EmailValidationSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EMAILVALIDATION_TEST_DOMAIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function domain_basic_setup($extra)
{
    ...
    $client = EmailValidationSDK::test($options, $extra);
    ...
    $entid_env_raw = getenv("EMAILVALIDATION_TEST_DOMAIN_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["EMAILVALIDATION_TEST_DOMAIN_ENTID"]);
    ...
    if ($env["EMAILVALIDATION_TEST_LIVE"] === "TRUE") {
        ...
        $client = new EmailValidationSDK(Helpers::to_map($merged_opts));
    }
