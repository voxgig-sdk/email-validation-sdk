...
// EmailValidation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EmailValidationOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EmailValidationOmni::structfix($now, Struct::undef()))
                        !== json_encode(EmailValidationOmni::structfix($val, Struct::undef()))) {
