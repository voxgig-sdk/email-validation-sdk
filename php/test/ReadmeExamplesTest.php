...
// EmailValidation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EmailValidationSDK::test)
...
{
    private const SDK_CLASS = 'EmailValidationSDK';
    ...
    private const SDK_BASE = 'emailvalidation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../emailvalidation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
