...
// EmailValidation SDK utility: result_basic

class EmailValidationResultBasic
{
    public static function call(EmailValidationContext $ctx): ?EmailValidationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EmailValidationError) ? $result->err->msg : (string)$result->err;
