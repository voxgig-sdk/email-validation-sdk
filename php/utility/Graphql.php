...
// EmailValidation SDK utility: graphql
//
...
class EmailValidationGraphql
{
    ...
    // equivalent.
    public static function body(EmailValidationContext $ctx): mixed
    {
    ...
    public static function errors(EmailValidationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
