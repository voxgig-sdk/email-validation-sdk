# EmailValidation TypeScript SDK Reference

Complete API reference for the EmailValidation TypeScript SDK.
...
```ts
new EmailValidationSDK(options?: object)
```
...
#### `EmailValidationSDK.test(testopts?, sdkopts?)`
...
**Returns:** `EmailValidationSDK` instance in test mode.
...
Alias for `EmailValidationSDK.test()`.
...
Return the parent `EmailValidationSDK` instance.
