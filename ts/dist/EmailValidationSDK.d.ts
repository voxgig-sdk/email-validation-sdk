...
declare class EmailValidationSDK {
    _mode: string;
    _options: any;
    _utility: Utility;
    _features: Feature[];
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): EmailValidationSDK;
    tester(testopts?: any, sdkopts?: any): EmailValidationSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof EmailValidationSDK;
export { stdutil, config, BaseFeature, EmailValidationEntityBase, EmailValidationSDK, SDK, };
