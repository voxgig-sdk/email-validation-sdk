# EmailValidation TypeScript SDK



The TypeScript SDK for the EmailValidation API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/email-validation-sdk/releases](https://github.com/voxgig-sdk/email-validation-sdk/releases)
...
```ts
const client = new EmailValidationSDK({ apikey: '...' })
...
```ts
new EmailValidationSDK(options?: {
  apikey?: string
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `EmailValidationSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `EmailValidationSDK.test(testopts?, sdkopts?)` | `EmailValidationSDK` | Create a test-mode client. |
...
| `client` | `client(): EmailValidationSDK` | Return the parent SDK client. |
...
email-validation/
├── src/
│   ├── EmailValidationSDK.ts        # Main SDK class
