...
(0, node_test_1.describe)('GenerateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set EMAIL_VALIDATION_TEST_GENERATE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['EMAIL_VALIDATION_TEST_GENERATE_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'EMAIL_VALIDATION_TEST_GENERATE_ENTID': idmap,
        'EMAIL_VALIDATION_TEST_LIVE': 'FALSE',
        'EMAIL_VALIDATION_TEST_EXPLAIN': 'FALSE',
        'EMAIL_VALIDATION_APIKEY': '',
    });
    idmap = env['EMAIL_VALIDATION_TEST_GENERATE_ENTID'];
