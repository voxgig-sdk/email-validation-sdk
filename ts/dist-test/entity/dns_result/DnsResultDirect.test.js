...
(0, node_test_1.describe)('DnsResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EmailValidationSDK({
...
function liveScenariosActive() { return false && process.env.EMAIL_VALIDATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'EMAIL_VALIDATION_TEST_DNS_RESULT_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.EmailValidationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.EMAIL_VALIDATION_APIKEY,
        }));
        let idmap = env['EMAIL_VALIDATION_TEST_DNS_RESULT_ENTID'];
    ...
    const client = new __1.EmailValidationSDK({
        base: 'http://localhost:8080',
