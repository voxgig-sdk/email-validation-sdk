...
func registerSDKWords(r *eng.Registry, client *sdk.EmailValidationSDK) {
...
func runOp(client *sdk.EmailValidationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
