module github.com/voxgig-sdk/email-validation-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/email-validation-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/email-validation-sdk/go => ../go
