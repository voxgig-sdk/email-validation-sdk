# EmailValidation Golang SDK



The Golang SDK for the EmailValidation API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
release tag — see [Releases](https://github.com/voxgig-sdk/email-validation-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/email-validation-sdk/go=../email-validation-sdk/go
```
...
import (
    "fmt"
    "os"
    sdk "github.com/voxgig-sdk/email-validation-sdk/go"
)
...
```
EMAIL_VALIDATION_TEST_LIVE=TRUE
EMAIL_VALIDATION_APIKEY=<your-key>
```
...
### NewEmailValidationSDK

```go
func NewEmailValidationSDK(options map[string]any) *EmailValidationSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EmailValidationSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### EmailValidationSDK methods
...
| `DnsResult` | `(data map[string]any) EmailValidationEntity` | Create a DnsResult entity instance. |
| `Domain` | `(data map[string]any) EmailValidationEntity` | Create a Domain entity instance. |
| `EmailValidate` | `(data map[string]any) EmailValidationEntity` | Create an EmailValidate entity instance. |
| `Generate` | `(data map[string]any) EmailValidationEntity` | Create a Generate entity instance. |
| `Grammar` | `(data map[string]any) EmailValidationEntity` | Create a Grammar entity instance. |
| `Ipn` | `(data map[string]any) EmailValidationEntity` | Create an Ipn entity instance. |
| `Redact` | `(data map[string]any) EmailValidationEntity` | Create a Redact entity instance. |
| `Ssl` | `(data map[string]any) EmailValidationEntity` | Create a Ssl entity instance. |
| `Utility` | `(data map[string]any) EmailValidationEntity` | Create an Utility entity instance. |
| `Whoi` | `(data map[string]any) EmailValidationEntity` | Create a Whoi entity instance. |

### Entity interface (EmailValidationEntity)

All entities implement the `EmailValidationEntity` interface.
...
```
github.com/voxgig-sdk/email-validation-sdk/go/
├── email-validation.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/email-validation-sdk/go`) re-exports everything needed
