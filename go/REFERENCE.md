# EmailValidation Golang SDK Reference

Complete API reference for the EmailValidation Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *EmailValidationSDK`
