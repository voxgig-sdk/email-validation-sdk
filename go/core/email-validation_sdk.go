...
import (
	...
	vs "github.com/voxgig-sdk/email-validation-sdk/go/utility/struct"
)

type EmailValidationSDK struct {
	Mode     string
...
func (sdk *EmailValidationSDK) OptionsMap() map[string]any {
...
func (sdk *EmailValidationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EmailValidationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EmailValidationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EmailValidationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *EmailValidationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *EmailValidationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("EmailValidationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *EmailValidationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EmailValidationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("EmailValidationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *EmailValidationSDK) DnsResult(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Domain(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) EmailValidate(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Generate(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Grammar(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Ipn(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Redact(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Ssl(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Utility(data map[string]any) EmailValidationEntity {
...
func (sdk *EmailValidationSDK) Whoi(data map[string]any) EmailValidationEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EmailValidationSDK {
	...
	sdk := NewEmailValidationSDK(sdkopts)
	sdk.Mode = "test"
