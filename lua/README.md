# EmailValidation Lua SDK



The Lua SDK for the EmailValidation API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/email-validation-sdk/releases)),
...
```
lua/
├── email-validation_sdk.lua    -- Main SDK module
...
The main module (`email-validation_sdk`) exports the SDK constructor
