...
local function make_error_util(ctx, err)
  ...
  local msg = "EmailValidationSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = EmailValidationError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == EmailValidationError then
