...
function runner.env_override(m)
  local live = runner.getenv("EMAILVALIDATION_TEST_LIVE")
  local override = runner.getenv("EMAILVALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EMAILVALIDATION_TEST_EXPLAIN")
