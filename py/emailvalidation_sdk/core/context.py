...
from emailvalidation_sdk.core.control import EmailValidationControl
...
from emailvalidation_sdk.core.helpers import get_ctx_prop, to_map
...
class EmailValidationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EmailValidationControl()
        ...
        if isinstance(sp, EmailValidationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EmailValidationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EmailValidationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EmailValidationError(code, msg, self)
