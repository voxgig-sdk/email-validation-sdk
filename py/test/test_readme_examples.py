# EmailValidation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EmailValidationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EmailValidationSDK(...) and EmailValidationSDK.test(...) become
#      EmailValidationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "emailvalidation_sdk"
_SDK_CLASS = "EmailValidationSDK"
