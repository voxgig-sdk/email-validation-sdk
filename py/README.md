# EmailValidation Python SDK



The Python SDK for the EmailValidation API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/email-validation-sdk/releases)) or
...
client = EmailValidationSDK(options)
```
...
```
py/
├── emailvalidation_sdk.py         -- Main SDK module
